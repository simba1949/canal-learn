...
public class QuickStartApplication {
	...
	public static void listenStart() {
		SocketAddress socketAddress = new InetSocketAddress("172.17.35.120", 11111);
		// destination 表示的是 canal server 的实例，默认的实例名称是 example，它代表一个完整的监听实例。
		String destination = "example";
		// 创建 canal 连接
		CanalConnector canalConnector = CanalConnectors.newSingleConnector(socketAddress, destination, "", "");
